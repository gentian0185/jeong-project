	...
	<center>
		...
		<table width="700">
			<tr>
				...
				<td align="right"><a href="/Spring_BBS_V5(Anno-Ibatis)/logout.hs">로그아웃 </a><a href="/Spring_BBS_V5(Anno-Ibatis)/writeForm.hs"> 글쓰기 </a></td>
			</tr>
		</table>
			...
			<c:forEach var="article" items="${article }">
				<tr height="30">
					...
					<td width="250">
						...
						<a href="/Spring_BBS_V5(Anno-Ibatis)/content.hs?article_num=${article.article_num }&pageNum=${pageNum}">
