...
<body>
	<!-- 수정 누를 경우  -->
	<form action="/BBSExample/replyForm.hs" method=post>
		...
		<table border="1" width="500" align="center">
			...
			<tr>
				...
				<td colspan="2"><a
					href="/BBSExample/download?file_name='${oneArticle.file_name }'"></a></td>
			</tr>
			<tr>
					...
					<td colspan="4" align="right"><input type="submit"
						value="답글달기"> <c:if test="${id ==oneArticle.id }">
							...
							<input type="button" value="수정하기" name="article_num" value="${oneArticle.article_num }"
								onclick="document.location.href='/BBSExample/updateForm.hs?article_num=${oneArticle.article_num }'">
							<input type="button" value="삭제하기" name="article_num"
								onclick="document.location.href='/BBSExample/deleteForm.hs?article_num=${oneArticle.article_num }'">
						...
						onclick="document.location.href='/BBSExample/list.hs?pageNum=${pageNum}'">
					</td>
				</c:if>
				<c:if test="${id ==null }">
					<td colspan="4" align="right"><input type="submit"
						...
						value="목록으로"
						onclick="document.location.href='/BBSExample/list.hs?pageNum=${pageNum}'"></td>
				</c:if>
			</tr>
		</table>
