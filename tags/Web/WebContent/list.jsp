	...
	<center>
		...
		<table width="700">
			<tr>
				...
				<td align="right"><a href="logout.jsp">로그아웃 </a><a href="/BBSExample/writeForm.hs"> 글쓰기 </a></td>
			</tr>
		</table>
			...
			<c:forEach var="article" items="${article }">
				<tr height="30">
					...
					<td width="250">
						...
						<a href="/BBSExample/content.hs?article_num=${article.article_num }&pageNum=${pageNum}">
