...
<body>
<form action="/BBSExample/update.hs" method="post">
		...
		<table border="2" width="200">
			...
			<tr>
				<td>제목 :</td>
				<td>[RE]<input type="text" name="title" value = "${article.title }"></td>
			...
			<tr>
				...
				<td><input type="reset" value="수정 취소"
					onclick="document.location.href='/BBSExample/list.hs'"></td>
			</tr>
		</table>
	</form>
</body>
